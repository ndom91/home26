...
standardSiteUri: at://did:plc:nmwj6xne7mdpkry5pzvfendv/site.standard.document/magicmirror-list
cover:
  imageFile: "./cover.png"
---

This is simply a collection of links, plugins, and parts used to build my ["MagicMirror"](https://magicmirror.builders).

This consists of an old 27" LCD monitor, a two-way mirror, and (optionally) a wooden frame.

You can check out my implementation below. As can you see, I've elected to not build a wooden frame. That was an aethestic choice, of course.. Nothing to do with my non-existant wood working skills of course.. 😅

![My Magic Mirror](./cover.jpg)

![](./2026.jpg)
Update 2026 - I built a simple wooden case with ventilation holes
...
- [x] Monitor
- Extra I had laying around [24" - 30cm x 53cm] **[€0,00]**
- [x] Raspberry Pi 3B+
  - Conrad **[€37,99]**
  - Powercable **[€8,99]**
- [x] Tape

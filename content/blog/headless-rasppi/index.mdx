...
standardSiteUri: at://did:plc:nmwj6xne7mdpkry5pzvfendv/site.standard.document/headless-rasppi
cover:
  imageFile: "./cover.png"
---
...
First, download an OS - for beginners I suggest Raspbian. Its a Debian based OS maintained by the Raspberry Pi Foundation.
...
- `if` = input file
- `of` = output file
- `status=progress` = show the write progress
...
>   IdentityFile /home/ndo/.ssh/id_rsa
> ```
>

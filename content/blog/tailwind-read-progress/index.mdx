...
category: "web"
standardSiteUri: at://did:plc:nmwj6xne7mdpkry5pzvfendv/site.standard.document/tailwind-read-progress
cover:
  imageFile: "./cover.png"
---
...
```jsx filename="src/components/ProgressBar.tsx"
const ProgressBar = () => {
  return (
    <div
      id="scroll-progress"

...
> [!TIP]
> You may have to install the `avahi-utils` package to get `avahi-browser`
...
Next, I setup a "pass" rule on the AP interface. Source = AP net, destination `fd01:7e50:6f0d:1::/64`, and set **state type to sloppy** (the return path is asymmetric enough that strict state tracking bites you).

...
discussionAtprotoUri: at://did:plc:nmwj6xne7mdpkry5pzvfendv/app.bsky.feed.post/3msopkp6grc2j
cover:
  imageFile: "./cover.png"
---
...
> [!TIP]
> The 3D model files can be found at the MakerWorld / Printables page here:
> - https://makerworld.com/en/models/3152351-digital-picture-frame-rpi
> - https://www.printables.com/model/1805733-digital-picture-frame-rpi
...
![Web app frame management list](./app_frameList.png)
![Web app media management masonry grid](./app_mediaList.png)
...
![Web app new frame on-boarding empty state](./app_onboarding.png)

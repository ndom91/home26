...
tags: ["mac", "linux", "work"]
category: "linux"
standardSiteUri: at://did:plc:nmwj6xne7mdpkry5pzvfendv/site.standard.document/macbook
cover:
  imageFile: "./cover.png"
---
...
Below are a few tools and widgets I've found that make me feel at home
...
- [Thaw](https://github.com/stonerl/Thaw) - Rewritten "Ice" menu bar management app for macOS 26
- [Handy](https://handy.computer) - On-device STT with developer friendly customization options
- [ProcessSpy](https://process-spy.app) - Power user process manager

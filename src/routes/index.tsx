...
const details = [
  ...
  { label: 'Habit', value: 'OSS', accentClass: '[--detail-accent:174_87_25]' },
      ...
      <div className="relative z-1 grid grid-cols-[minmax(0,1.1fr)_minmax(20rem,0.9fr)] gap-px border-b border-rule max-[820px]:grid-cols-1">
        ...
        >
          <div>
            ...
            <h1
              id="home-title"
              className="m-0 max-w-[12ch] font-logo text-[clamp(3.2rem,12vw,12rem)] font-bold leading-[0.8] -tracking-widest"
            >
              .domino
            </h1>
          </div>
        ...
        >
          <section className="relative grid min-h-[28rem] content-end overflow-hidden bg-ink p-[clamp(1.25rem,3vw,3rem)] text-paper">
            <AsciiGlobe />
            <p className="relative m-0 max-w-[35rem] text-[clamp(1.25rem,2.1vw,2.3rem)] leading-[1.16] tracking-[-0.04em]">
